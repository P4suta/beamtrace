...
- [0007](0007-web-time-rendering-from-decimal-strings.md) — Human time labels are computed from decimal strings
...
- [0017](0017-project-config-discovery-stops-at-the-repository-boundary.md) — Project configuration discovery stops at the repository boundary
