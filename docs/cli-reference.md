...
| `E_CAPTURE_ARM_FAILED` | `capture_arm_failed` | 2 |
...
| `E_CHILD_RELEASE_FAILED` | `child_release_failed` | 2 |
| `E_CHILD_SHUTDOWN_FAILED` | `child_shutdown_failed` | 2 |
| `E_CHILD_START_FAILED` | `child_start_failed` | 2 |
| `E_CHILD_WAIT_FAILED` | `child_wait_failed` | 2 |
| `E_COMMAND_FAILED` | `command_failed` | 2 |
| `E_COMMAND_NOT_FOUND` | `command_not_found` | 2 |
| `E_CONFIGURATION_CREATE_FAILED` | `configuration_create_failed` | 2 |
| `E_COOKIE_UNAVAILABLE` | `cookie_unavailable` | 2 |
| `E_DEMO_FIXTURE_UNAVAILABLE` | `demo_fixture_unavailable` | 2 |
| `E_DUPLICATE_ENTRY` | `duplicate_entry` | 2 |
| `E_EXPORT_CONVERSION_FAILED` | `export_conversion_failed` | 2 |
| `E_EXPORT_WRITE_FAILED` | `export_write_failed` | 2 |
| `E_INVALID_ARGUMENTS` | `invalid_arguments` | 2 |
| `E_INVALID_CONFIGURATION` | `invalid_configuration` | 2 |
| `E_INVALID_CONTAINER` | `invalid_container` | 2 |
| `E_INVALID_GRAPH` | `invalid_graph` | 2 |
| `E_INVALID_PATHS` | `invalid_paths` | 2 |
